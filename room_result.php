  ...
  <body>
    ...
    <header role="banner">
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-light">
        <div class="container">
          <a class="navbar-brand" href="index.html">instant_room</a>
          ...
          <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
            ...
            <div class="log">
          <div class="login-box">
            <button onclick="document.getElementById('id01').style.display='block'" style="width:auto;"><a href="login_page/register.php" class="selectpicker show-tick form-control" id="basic" >Sign Up</a></button>
                        <button onclick="document.getElementById('id01').style.display='block'" style="width:auto;"><a href="login_page/login.php" class="selectpicker show-tick form-control" id="basic" >login</a></button>
          </div>
          </div>
        </div>
        ...
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <div class="mb-5 element-animate">
              ...
              <p>Discover &amp; connect with great rooms around the India.</p>
            </div>

            <form class="form-inline element-animate" id="search-form" method="get" >
              <label for="s" class="sr-only">Location</label>
              <input type="text" class="form-control form-control-block search-input" id="autocomplete" placeholder="Search Location For Room" onFocus="geolocate()" name="location">
...
{     
	?>
	<table align="center" width="50%" border="1" style="margin-top:15px;">
		<tr>
			<th>Serial Number</th>
	...
	$qry="select * from room_info where room_location like '%$location%';";
	$res=mysqli_query($con,$qry);

	if(mysqli_num_rows($res)<1)
	{
		  echo "<table align='center'style='margin-top:30px;'><tr><td><h3>No records Found </h3></td></tr></table>";
	}
	else
	{
		$count=0;
		...
		while($data=mysqli_fetch_array($res))
		{
			...
			<tr>
				...
				<td><?php echo $data['cont_number']; ?></td>
				<td><img src="landlord_profile/image/<?php echo $data['room_image']; ?> " style="max-width:200px;"/></td>
