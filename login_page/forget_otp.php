...
if($count>0)
{
    ...
    window.open('new_pass.php','_self');
...
else
{
    ...
    window.open('forget_otp.php','_self');</script>";
}
}
?>
				...
				<div class="myform form ">
                   ...
                   <form action="" method="post" name="login">
                           ...
                           <div class="form-group" style="margin:40px 0px; font-size:14px;">
                              <p class="text-center" >A verification code has sent to your Registered Email address<br><div class="form-group text-center">Enter the Code below to create a new password</div></p>
                           </div>
